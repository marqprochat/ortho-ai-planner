...
const DentalConnectIcon = () => (
    <svg viewBox="0 0 64 64" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="dc-dash-bg" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="#10b981" />
                <stop offset="100%" stopColor="#0d9488" />
            </linearGradient>
        </defs>
        <rect width="64" height="64" rx="14" fill="url(#dc-dash-bg)" />
        <path d="M32 9 C25.5 9 18 13.5 16.5 22 C15.2 29.5 17 37 19 43.5 C20.5 49 22.5 53.5 25.5 50.5 C27.5 48 29.5 46.5 32 46.5 C34.5 46.5 36.5 48 38.5 50.5 C41.5 53.5 43.5 49 45 43.5 C47 37 48.8 29.5 47.5 22 C46 13.5 38.5 9 32 9Z" fill="white" />
...
const iconMap: Record<string, React.ReactNode> = {
    ...
    DentalConnect: <DentalConnectIcon />,
};
